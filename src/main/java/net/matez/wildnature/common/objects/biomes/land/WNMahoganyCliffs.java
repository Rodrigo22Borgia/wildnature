...
public class WNMahoganyCliffs extends WNBiome { 
    public WNMahoganyCliffs() { 
        super(WNBiomes.MahoganyCliffs, Biome.Precipitation.RAIN, Biome.BiomeCategory.JUNGLE, 0.7F, 0.8F, NORMAL_MUSIC, 0x89D036 /*0x81D417*/, 0x72D624 /*0x92DD29*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        //addPlant(event, FruitBushType.COFFEE_SAPLING, 12);
}

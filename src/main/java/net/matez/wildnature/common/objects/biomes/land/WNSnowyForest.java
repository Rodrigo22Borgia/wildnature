...
public class WNSnowyForest extends WNBiome { 
    public WNSnowyForest() { 
        super(WNBiomes.SnowyForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, -0.2F, 0.8F, NORMAL_MUSIC, 0x75B420 /*0x6DAE00*/, 0xFBFF00 /*0xFFEA00*/);
    }

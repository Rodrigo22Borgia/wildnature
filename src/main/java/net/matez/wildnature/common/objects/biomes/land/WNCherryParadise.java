...
public class WNCherryParadise extends WNBiome { 
    public WNCherryParadise() { 
        super(WNBiomes.CherryParadise, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x3FCF64 /*0x7BCF21*/, 0);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.TREE_OAK, 3, 0.5F, 2);

        // -- FLOWERS
        //addPlant(event, FlowerType.CHERRY_FLOWER, 4);

...
public class WNGoldenWoods extends WNBiome { 
    public WNGoldenWoods() { 
        super(WNBiomes.GoldenWoods, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0xBAEE00 /*0xCEE900*/, 0xFFB800 /*0xFBE800*/);
    }

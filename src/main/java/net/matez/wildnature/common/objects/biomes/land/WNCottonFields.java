...
public class WNCottonFields extends WNBiome { 
    public WNCottonFields() { 
        super(WNBiomes.CottonFields, Biome.Precipitation.RAIN, Biome.BiomeCategory.PLAINS, 0.6F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        // -- FLOWERS
        addPlant(event, FlowerType.GRASS_FLOWER, 12);

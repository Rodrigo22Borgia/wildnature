...
public class WNBorealValley extends WNBiome { 
    public WNBorealValley() { 
        super(WNBiomes.BorealValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.2F, 0.8F, NORMAL_MUSIC, 0, 0);
    }
    ...
    public MobSpawnSettings.Builder buildMobSpawn() {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.COW, 12, 4, 4));

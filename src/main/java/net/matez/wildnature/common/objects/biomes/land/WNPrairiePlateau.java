...
public class WNPrairiePlateau extends WNBiome { 
    public WNPrairiePlateau() { 
        super(WNBiomes.PrairiePlateau, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0xC7AF95 /*0xB5B594*/, 0x7DC400 /*0x9CCD00*/);
    }

...
public class WNTatraFireweedValley extends WNBiome { 
    public WNTatraFireweedValley() { 
        super(WNBiomes.TatraFireweedValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.3F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }

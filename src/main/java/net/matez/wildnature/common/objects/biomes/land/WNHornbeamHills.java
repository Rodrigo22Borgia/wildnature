...
public class WNHornbeamHills extends WNBiome { 
    public WNHornbeamHills() { 
        super(WNBiomes.HornbeamHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.8F, NORMAL_MUSIC, 0x81C46A /*0x95CF65*/, 0x5CB72B /*0x5EBD32*/);
    }

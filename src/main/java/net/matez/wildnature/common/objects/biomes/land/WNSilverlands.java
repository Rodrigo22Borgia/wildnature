...
public class WNSilverlands extends WNBiome { 
    public WNSilverlands() { 
        super(WNBiomes.Silverlands, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.3F, 0.4F, NORMAL_MUSIC, 0x76C481 /*0x8BC478*/, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FlowerType.SNOWDROP, 12);

...
public class WNSequoiaHills extends WNBiome { 
    public WNSequoiaHills() { 
        super(WNBiomes.SequoiaHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.5F, 0.8F, NORMAL_MUSIC, 0x90E265 /*0x91DA53*/, 0x8CD660 /*0x9DE549*/);
    }

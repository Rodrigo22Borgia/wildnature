...
public class WNDaintreeForest extends WNBiome { 
    public WNDaintreeForest() { 
        super(WNBiomes.DaintreeForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.JUNGLE, 0.95F, 0.8F, NORMAL_MUSIC, 0xB7CB65 /*0xA7CB27*/, 0x58C94C /*0x8BC949*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.EUCALYPTUS, 1, 0.5F, 2);
        ...
        addTree(event, WNExtraTrees.PALM, 1, 0.5F, 2);

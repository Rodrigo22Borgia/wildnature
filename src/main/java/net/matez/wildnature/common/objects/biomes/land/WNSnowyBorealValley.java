...
public class WNSnowyBorealValley extends WNBiome { 
    public WNSnowyBorealValley() { 
        super(WNBiomes.SnowyBorealValley, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.5F, 0.3F, NORMAL_MUSIC, 0x2E8545 /*0x307D31*/, 0xFBFF00 /*0xFFEA00*/);
    }

...
public class WNColdForest extends WNBiome { 
    public WNColdForest() { 
        super(WNBiomes.ColdForest, Biome.Precipitation.SNOW, Biome.BiomeCategory.FOREST, -0.1F, 0.8F, NORMAL_MUSIC, 0x75B420 /*0x6DAE00*/, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.BALD_HIGH_OAK_, 5, 0.5F, 2);
        addTree(event, WNExtraTrees.BALD_OAK_, 2, 0.5F, 2);

        // -- FLOWERS
        addPlant(event, FlowerType.CLOVER, 4);
        addPlant(event, FlowerType.HEPATICA_VIOLET, 6);
        addPlant(event, FlowerType.HEPATICA_WHITE, 6);

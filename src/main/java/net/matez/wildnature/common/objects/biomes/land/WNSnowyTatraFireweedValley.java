...
public class WNSnowyTatraFireweedValley extends WNBiome { 
    public WNSnowyTatraFireweedValley() { 
        super(WNBiomes.SnowyTatraFireweedValley, Biome.Precipitation.SNOW, Biome.BiomeCategory.EXTREME_HILLS, -0.5F, 0.8F, NORMAL_MUSIC, 0x85C864 /*0xBECF70*/, 0xFBFF00 /*0xFFEA00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FlowerType.CROCUS_WHITE, 4);

...
public class WNSnowyTatraLowerForest extends WNBiome { 
    public WNSnowyTatraLowerForest() { 
        super(WNBiomes.SnowyTatraLowerForest, Biome.Precipitation.SNOW, Biome.BiomeCategory.EXTREME_HILLS, -0.6F, 0.9F, NORMAL_MUSIC, 0x87C250 /*0x72C248*/, 0xFBFF00 /*0xFFEA00*/);
    }

...
public class WNSnowyGiewont extends WNBiome { 
    public WNSnowyGiewont() { 
        super(WNBiomes.SnowyGiewont, Biome.Precipitation.SNOW, Biome.BiomeCategory.EXTREME_HILLS, -0.7F, 0.975F, NORMAL_MUSIC, 0x85C864 /*0xBECF70*/, 0xFBFF00 /*0xFFEA00*/);
    }

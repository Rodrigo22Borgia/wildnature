...
public class WNSnowyTatraKasprowyPeak extends WNBiome { 
    public WNSnowyTatraKasprowyPeak() { 
        super(WNBiomes.SnowyTatraKasprowyPeak, Biome.Precipitation.SNOW, Biome.BiomeCategory.EXTREME_HILLS, -0.8F, 0.975F, NORMAL_MUSIC, 0x85C864 /*0xBECF70*/, 0xFBFF00 /*0xFFEA00*/);
    }

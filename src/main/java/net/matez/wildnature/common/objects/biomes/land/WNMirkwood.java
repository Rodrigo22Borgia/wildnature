...
public class WNMirkwood extends WNBiome { 
    public WNMirkwood() { 
        super(WNBiomes.Mirkwood, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.2F, NORMAL_MUSIC, 0x4B8936 /*0x379537*/, 0x72D624 /*0x92DD29*/);
    }

    @Override
    public MobSpawnSettings.Builder buildMobSpawn() {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        spawnBuilder.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.BAT, 10, 2, 6));
        spawnBuilder.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.BAT, 25, 8, 8));
        ...
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 35, 1, 2));
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.SPOOKY_BIG, 2, 0.5F, 2);

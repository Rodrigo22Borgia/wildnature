...
public class WNWeepingBirchForest extends WNBiome { 
    public WNWeepingBirchForest() { 
        super(WNBiomes.WeepingBirchForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.8F, NORMAL_MUSIC, 0x51973D /*0x47B847*/, 0x7EC948 /*0xA7D549*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.BIRCH, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.POINTY_BIRCH, 3, 0.5F, 2);

...
public class WNHazelFields extends WNBiome { 
    public WNHazelFields() { 
        super(WNBiomes.HazelFields, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x6AA845 /*0x58A352*/, 0x5CB72B /*0x5EBD32*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.HAZEL, 3, 0.5F, 2);

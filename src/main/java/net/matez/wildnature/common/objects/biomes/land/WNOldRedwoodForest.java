...
public class WNOldRedwoodForest extends WNBiome { 
    public WNOldRedwoodForest() { 
        super(WNBiomes.OldRedwoodForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x59C236 /*0x87DD34*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.TREE_REDWOOD, 1, 0.5F, 2);

...
public class WNDeciduousForest extends WNBiome { 
    public WNDeciduousForest() { 
        super(WNBiomes.DeciduousForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x67C703 /*0x75B300*/, 0x58C94C /*0x8BC949*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.TREE_HORNBEAM, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.TREE_OAK, 2, 0.5F, 2);

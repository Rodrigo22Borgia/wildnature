...
public class WNTatraUpperForest extends WNBiome { 
    public WNTatraUpperForest() { 
        super(WNBiomes.TatraUpperForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.25F, 0.95F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0x5DB259 /*0x7FBC70*/);
    }

...
public class WNGrasslandsHills extends WNBiome { 
    public WNGrasslandsHills() { 
        super(WNBiomes.GrasslandsHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0xBAEE00 /*0xCEE900*/, 0xFFB800 /*0xFBE800*/);
    }

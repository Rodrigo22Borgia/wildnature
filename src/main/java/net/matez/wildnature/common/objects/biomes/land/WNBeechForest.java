...
public class WNBeechForest extends WNBiome { 
    public WNBeechForest() { 
        super(WNBiomes.BeechForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x95DF55 /*0x90D849*/, 0x2ACC00 /*0x67D600*/);
    }

...
public class WNForestedMountains extends WNBiome { 
    public WNForestedMountains() { 
        super(WNBiomes.ForestedMountains, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.4F, 0.3F, NORMAL_MUSIC, 0x81C46A /*0x95CF65*/, 0xA0C18D /*0x9CC179*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FlowerType.PASQUE_PINK, 12);

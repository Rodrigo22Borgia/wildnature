...
public class WNSunflowerFields extends WNBiome { 
    public WNSunflowerFields() { 
        super(WNBiomes.SunflowerFields, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.35F, 0.8F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0xFBFF00 /*0xFFEA00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.THIN_BIRCH, 4, 0.5F, 2);
        ...
        addPlant(event, FlowerType.VIOLET_PURPLE, 4);

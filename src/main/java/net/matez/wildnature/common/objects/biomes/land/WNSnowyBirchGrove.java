...
public class WNSnowyBirchGrove extends WNBiome { 
    public WNSnowyBirchGrove() { 
        super(WNBiomes.SnowyBirchGrove, Biome.Precipitation.SNOW, Biome.BiomeCategory.FOREST, -0.3F, 0.8F, NORMAL_MUSIC, 0x2E8545 /*0x307D31*/, 0xFBFF00 /*0xFFEA00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.TREE_BIRCH, 2, 0.5F, 2);

...
public class WNRedwoodForest extends WNBiome { 
    public WNRedwoodForest() { 
        super(WNBiomes.RedwoodForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0, 0);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.SMALL_REDWOOD, 1, 0.5F, 2);

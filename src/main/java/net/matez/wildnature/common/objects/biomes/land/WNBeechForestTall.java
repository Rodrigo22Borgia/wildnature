...
public class WNBeechForestTall extends WNBiome { 
    public WNBeechForestTall() { 
        super(WNBiomes.BeechForestTall, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x95DF55 /*0x90D849*/, 0x2ACC00 /*0x67D600*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.HIGH_BEECH_, 3, 0.5F, 2);

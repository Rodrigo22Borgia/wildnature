...
public class WNMangroveBayou extends WNBiome { 
    public WNMangroveBayou() { 
        super(WNBiomes.MangroveBayou, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.8F, 0.9F, NORMAL_MUSIC, 0x7DAD51 /*0x66AD47*/, 0x72D624 /*0x92DD29*/);
    }
    ...
    public MobSpawnSettings.Builder buildMobSpawn() {
        ...
        spawnBuilder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.DOLPHIN, 1, 1, 1));
        spawnBuilder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PUFFERFISH, 3, 1, 5));
        spawnBuilder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 2, 1, 4));
        spawnBuilder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 5, 1, 5));
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.MANGROVE, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.MANGROVE_SHRUB, 2, 0.5F, 2);

        // -- FLOWERS
        addPlant(event, WaterPlant.DUCKWEED, 0);
        addPlant(event, WaterPlant.GREEN_LILY_PAD, 0);
        addPlant(event, WaterPlant.RED_LILY_PAD, 6);
}

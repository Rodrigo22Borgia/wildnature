...
public class WNCracowGorge extends WNBiome { 
    public WNCracowGorge() { 
        super(WNBiomes.CracowGorge, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.23F, 0.9F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0x5DB259 /*0x7FBC70*/);
    }

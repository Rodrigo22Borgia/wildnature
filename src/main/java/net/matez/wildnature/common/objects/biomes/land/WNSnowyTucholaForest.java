...
public class WNSnowyTucholaForest extends WNBiome { 
    public WNSnowyTucholaForest() { 
        super(WNBiomes.SnowyTucholaForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, -0.5F, 0.3F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0xFBFF00 /*0xFFEA00*/);
    }

...
public class WNBeechValley extends WNBiome { 
    public WNBeechValley() { 
        super(WNBiomes.BeechValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x95DF55 /*0x90D849*/, 0x2ACC00 /*0x67D600*/);
    }

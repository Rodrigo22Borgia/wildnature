...
public class WNCaatingaHills extends WNBiome { 
    public WNCaatingaHills() { 
        super(WNBiomes.CaatingaHills, Biome.Precipitation.NONE, Biome.BiomeCategory.SAVANNA, 1F, 0.0F, NORMAL_MUSIC, 0xD0D67B /*0xD6C495*/, 0);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        //addBush(event, Blocks.DEAD_BUSH, 1);

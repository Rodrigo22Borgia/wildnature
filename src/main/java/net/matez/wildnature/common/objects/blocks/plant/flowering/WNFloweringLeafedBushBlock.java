...
public class WNFloweringLeafedBushBlock extends WNFloweringBushBlock{
    public WNFloweringLeafedBushBlock(ResourceLocation location, Properties properties, FlowerType type) {
        super(location, properties, type);
    }

    public WNFloweringLeafedBushBlock(ResourceLocation location, Properties properties, Item.Properties itemProperties, FlowerType type) {

...
public class WNRoofedForest extends WNBiome { 
    public WNRoofedForest() { 
        super(WNBiomes.RoofedForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.DARK_HIGH_OAK_, 7, 0.5F, 2);

...
public class WNBaobabSavanna extends WNBiome { 
    public WNBaobabSavanna() { 
        super(WNBiomes.BaobabSavanna, Biome.Precipitation.NONE, Biome.BiomeCategory.SAVANNA, 1F, 0.0F, NORMAL_MUSIC, 0x73E028 /*0x51DD11*/, 0x7DC400 /*0x9CCD00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.ACACIA, 2, 0.5F, 2);

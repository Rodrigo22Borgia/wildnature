...
public class WNDenseTucholaForest extends WNBiome { 
    public WNDenseTucholaForest() { 
        super(WNBiomes.DenseTucholaForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.2F, 0.3F, NORMAL_MUSIC, 0xA0C18D /*0x9CC179*/);
    }

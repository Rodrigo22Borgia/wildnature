...
public class WNColdSilverlands extends WNBiome { 
    public WNColdSilverlands() { 
        super(WNBiomes.ColdSilverlands, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, -0.3F, 0.4F, NORMAL_MUSIC, 0x76C481 /*0x8BC478*/, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.SILVER_FIR, 5, 0.5F, 2);
        ...
        //addPlant(event, FlowerType.BROWN_GRASS_BLOCK, 12);
        ...
        addPlant(event, FlowerType.SNOWDROP, 6);

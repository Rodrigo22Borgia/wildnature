...
public class WNGiantConiferousForest extends WNBiome { 
    public WNGiantConiferousForest() { 
        super(WNBiomes.GiantConiferousForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.3F, 0.4F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.TREE_FIR, 5, 0.5F, 2);
        addTree(event, WNExtraTrees.TREE_TAIGA, 5, 0.5F, 2);

...
public enum FlowerType implements PlantFeature {
    ...
    GRASS_FLOWER(FlowerColor.GREEN,0xC2C66D, BushVariant.GRASS_FLOWER,128, 8,2),
    GRASS_WHEAT(FlowerColor.GREEN,0xCEC48A, BushVariant.GRASS_WHEAT,128, 8,2),
    ...
    LAMPGRASS(FlowerColor.YELLOW, 0xE5E695, BushVariant.LAMPGRASS,128, 8,2),
    ...
    PRAIRIE_GRASS(FlowerColor.YELLOW, 0xD8A763, BushVariant.PRAIRIE_GRASS,128, 8,2),
    ...
    WILD_WHEAT(FlowerColor.YELLOW, 0xD8CA6E, BushVariant.WILD_WHEAT,128, 8,2),

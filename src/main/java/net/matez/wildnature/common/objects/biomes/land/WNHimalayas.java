...
public class WNHimalayas extends WNBiome { 
    public WNHimalayas() { 
        super(WNBiomes.Himalayas, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, -0.25F, 0.9F, NORMAL_MUSIC, 0x81C46A /*0x95CF65*/, 0x5CB72B /*0x5EBD32*/);
    }
    ...
    public MobSpawnSettings.Builder buildMobSpawn() {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.POLAR_BEAR, 5, 4, 4));

...
public class WNBirchMarsh extends WNBiome { 
    public WNBirchMarsh() { 
        super(WNBiomes.BirchMarsh, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.25F, 0.8F, NORMAL_MUSIC, 0x2E8545 /*0x307D31*/, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FlowerType.GLADIOLUS_PURPLE, 12);

...
public class WNColdBerryTaiga extends WNBiome { 
    public WNColdBerryTaiga() { 
        super(WNBiomes.ColdBerryTaiga, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.5F, 0.5F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FruitPlantType.WILD_BLUEBERRY, 0);

...
public class WNTaigaMarsh extends WNBiome { 
    public WNTaigaMarsh() { 
        super(WNBiomes.TaigaMarsh, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.21F, 0.5F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.THIN_BIRCH, 6, 0.5F, 2);

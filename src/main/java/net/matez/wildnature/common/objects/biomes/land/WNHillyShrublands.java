...
public class WNHillyShrublands extends WNBiome { 
    public WNHillyShrublands() { 
        super(WNBiomes.HillyShrublands, Biome.Precipitation.RAIN, Biome.BiomeCategory.PLAINS, 0.6F, 0.8F, NORMAL_MUSIC, 0x81C46A /*0x95CF65*/, 0x5CB72B /*0x5EBD32*/);
    }

...
public class WNDenseMoor extends WNBiome { 
    public WNDenseMoor() { 
        super(WNBiomes.DenseMoor, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.25F, 0.7F, NORMAL_MUSIC, 0xA0C18D /*0x9CC179*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.TALL_PINE, 3, 0.5F, 2);

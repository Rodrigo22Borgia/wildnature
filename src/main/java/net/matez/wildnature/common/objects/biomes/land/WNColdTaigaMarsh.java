...
public class WNColdTaigaMarsh extends WNBiome { 
    public WNColdTaigaMarsh() { 
        super(WNBiomes.ColdTaigaMarsh, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.5F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        //addPlant(event, FlowerType.PARROTS_FEATHER_PLANT, 1);

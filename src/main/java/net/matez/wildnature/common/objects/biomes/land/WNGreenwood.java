...
public class WNGreenwood extends WNBiome { 
    public WNGreenwood() { 
        super(WNBiomes.Greenwood, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.8F, NORMAL_MUSIC, 0x6AA845 /*0x58A352*/, 0x5CB72B /*0x5EBD32*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.GREENWOOD, 4, 0.5F, 2);
        ...
        addPlant(event, FlowerType.HYACINTH_WHITE, 6);
        ...
        addPlant(event, FlowerType.VIOLET_PURPLE, 3);

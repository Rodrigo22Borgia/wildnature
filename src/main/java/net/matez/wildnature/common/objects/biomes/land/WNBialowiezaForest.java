...
public class WNBialowiezaForest extends WNBiome { 
    public WNBialowiezaForest() { 
        super(WNBiomes.BialowiezaForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.3F, 0.4F, NORMAL_MUSIC, 0x458547 /*0x539855*/, 0x5DB259 /*0x7FBC70*/);
    }

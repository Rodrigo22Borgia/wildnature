...
public class WNBerryTaiga extends WNBiome { 
    public WNBerryTaiga() { 
        super(WNBiomes.BerryTaiga, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.21F, 0.5F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addBush(event, FruitBushType.BLUEBERRY, 0);

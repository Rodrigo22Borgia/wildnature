...
public class WNMasuria extends WNBiome { 
    public WNMasuria() { 
        super(WNBiomes.Masuria, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x6CC511 /*0x8DC557*/, 0x72D624 /*0x92DD29*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.HIGH_OAK_, 4, 0.5F, 2);
        ...
        //addPlant(event, FlowerType.DAISY, 12);
        ...
        addPlant(event, FlowerType.MARIGOLD_WHITE, 12);

...
public class WNRainforestMoor extends WNBiome { 
    public WNRainforestMoor() { 
        super(WNBiomes.RainforestMoor, Biome.Precipitation.RAIN, Biome.BiomeCategory.JUNGLE, 0.7F, 0.9F, NORMAL_MUSIC, 0, 0);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.JUNGLE_MEDIUM, 1, 0.5F, 2);

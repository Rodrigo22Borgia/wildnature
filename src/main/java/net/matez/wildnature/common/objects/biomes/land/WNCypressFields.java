...
public class WNCypressFields extends WNBiome { 
    public WNCypressFields() { 
        super(WNBiomes.CypressFields, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.35F, 0.9F, NORMAL_MUSIC, 0xB7CB65 /*0xA7CB27*/, 0x58C94C /*0x8BC949*/);
    }

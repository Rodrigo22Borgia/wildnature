...
public class WNTemperateSequoiaRainforest extends WNBiome { 
    public WNTemperateSequoiaRainforest() { 
        super(WNBiomes.TemperateSequoiaRainforest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.23F, 1F, NORMAL_MUSIC, 0x81EE59 /*0x78DA42*/, 0x8CD660 /*0x9DE549*/);
    }

...
public class WNWetlands extends WNBiome { 
    public WNWetlands() { 
        super(WNBiomes.Wetlands, Biome.Precipitation.RAIN, Biome.BiomeCategory.PLAINS, 0.6F, 0.8F, NORMAL_MUSIC, 0x51973D /*0x47B847*/, 0x7EC948 /*0xA7D549*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        // -- FLOWERS
        addPlant(event, FlowerType.BUTTERCUP_ORANGE, 12);
        addPlant(event, FlowerType.BUTTERCUP_YELLOW, 12);

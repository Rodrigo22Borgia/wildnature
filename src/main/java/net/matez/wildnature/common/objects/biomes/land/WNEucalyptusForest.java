...
public class WNEucalyptusForest extends WNBiome { 
    public WNEucalyptusForest() { 
        super(WNBiomes.EucalyptusForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.JUNGLE, 0.7F, 0.9F, NORMAL_MUSIC, 0xA0C18D /*0x9CC179*/);
    }
    ...
    public MobSpawnSettings.Builder buildMobSpawn() {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.PANDA, 6, 2, 4));

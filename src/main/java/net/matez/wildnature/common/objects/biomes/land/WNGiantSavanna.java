...
public class WNGiantSavanna extends WNBiome { 
    public WNGiantSavanna() { 
        super(WNBiomes.GiantSavanna, Biome.Precipitation.NONE, Biome.BiomeCategory.SAVANNA, 1F, 0.0F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        // -- TREES
        addTree(event, WNExtraTrees.ACACIA, 3, 0.5F, 2);
        addTree(event, WNExtraTrees.BAOBAB, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.BIG_ACACIA, 10, 0.5F, 2);
        addTree(event, WNExtraTrees.GIANT_BAOBAB, 7, 0.5F, 2);

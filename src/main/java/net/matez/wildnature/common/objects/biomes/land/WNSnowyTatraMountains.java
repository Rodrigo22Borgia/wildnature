...
public class WNSnowyTatraMountains extends WNBiome { 
    public WNSnowyTatraMountains() { 
        super(WNBiomes.SnowyTatraMountains, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, -0.7F, 0.975F, NORMAL_MUSIC, 0x9ED96F /*0xC7D975*/, 0xFBFF00 /*0xFFEA00*/);
    }

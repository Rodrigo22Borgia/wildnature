...
public class WNPoplarForestHills extends WNBiome { 
    public WNPoplarForestHills() { 
        super(WNBiomes.PoplarForestHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.55F, 0.8F, NORMAL_MUSIC, 0x8AC700 /*0x7DB300*/, 0x7DC400 /*0x9CCD00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.TREE_BIRCH, 8, 0.5F, 2);
        ...
        addPlant(event, FlowerType.HOLLYHOCK_RED, 2);
        addPlant(event, FlowerType.HYDRANGEA_WHITE, 1);

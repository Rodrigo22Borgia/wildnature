...
public class WNSnowyCedarForest extends WNBiome { 
    public WNSnowyCedarForest() { 
        super(WNBiomes.SnowyCedarForest, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.1F, 0.3F, NORMAL_MUSIC, 0x2E8545 /*0x307D31*/, 0xFBFF00 /*0xFFEA00*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addPlant(event, FlowerType.FERNSPROUT, 3);
        ...
        addPlant(event, FlowerType.VIBURNUM_PINK, 4);
        addPlant(event, FlowerType.VIBURNUM_WHITE, 4);

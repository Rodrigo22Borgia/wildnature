...
public class WNSnowyTucholaForestHill extends WNBiome { 
    public WNSnowyTucholaForestHill() { 
        super(WNBiomes.SnowyTucholaForestHill, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.5F, 0.3F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0xFBFF00 /*0xFFEA00*/);
    }

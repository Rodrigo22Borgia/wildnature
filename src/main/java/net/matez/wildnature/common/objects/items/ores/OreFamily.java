...
public enum OreFamily {
    ...
    DARK_AMETHYST("dark_amethyst", new WNTier(6, 2200, 12f , 4F  , -3f  , 20, BlockTags.ANVIL, () -> Ingredient.of(WNItems.ORE_ITEMS.get(OreItem.DARK_AMETHYST)))),
    RUBY("ruby"                  , new WNTier(4, 1200, 8.5f, 3F, -3f  , 13, BlockTags.ANVIL, () -> Ingredient.of(WNItems.ORE_ITEMS.get(OreItem.RUBY)))),
    SAPPHIRE("sapphire"          , new WNTier(4, 1200, 8.5f, 3F, -3f  , 13, BlockTags.ANVIL, () -> Ingredient.of(WNItems.ORE_ITEMS.get(OreItem.SAPPHIRE)))),
    ...
    TIN("tin"),
    TOPAZ("topaz"                , new WNTier(5, 1800, 9.5f, 3.5F, -2.9f, 16, BlockTags.ANVIL, () -> Ingredient.of(WNItems.ORE_ITEMS.get(OreItem.TOPAZ)))),

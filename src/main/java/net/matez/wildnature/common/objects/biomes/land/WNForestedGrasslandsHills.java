...
public class WNForestedGrasslandsHills extends WNBiome { 
    public WNForestedGrasslandsHills() { 
        super(WNBiomes.ForestedGrasslandsHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x75B420 /*0x6DAE00*/, 0xA0C18D /*0x9CC179*/);
    }

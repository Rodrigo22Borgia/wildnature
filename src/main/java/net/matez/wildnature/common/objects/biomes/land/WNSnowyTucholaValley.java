...
public class WNSnowyTucholaValley extends WNBiome { 
    public WNSnowyTucholaValley() { 
        super(WNBiomes.SnowyTucholaValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, -0.5F, 0.3F, NORMAL_MUSIC, 0x81BF53 /*0x72C248*/, 0xFBFF00 /*0xFFEA00*/);
    }

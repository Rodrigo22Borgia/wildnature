...
public class WNAutumnalPoplarForestHills extends WNBiome { 
    public WNAutumnalPoplarForestHills() { 
        super(WNBiomes.AutumnalPoplarForestHills, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.25F, 0.8F, NORMAL_MUSIC, 0xA64A25 /*0xA67131*/, 0xC72600 /*0xD03F00*/);
    }

...
public class WNTatraChocholowskaGlade extends WNBiome { 
    public WNTatraChocholowskaGlade() { 
        super(WNBiomes.TatraChocholowskaGlade, Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.25F, 0.8F, NORMAL_MUSIC);
    }

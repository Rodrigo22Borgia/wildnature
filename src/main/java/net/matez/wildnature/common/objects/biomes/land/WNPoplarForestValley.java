...
public class WNPoplarForestValley extends WNBiome { 
    public WNPoplarForestValley() { 
        super(WNBiomes.PoplarForestValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0xC7AF95 /*0xB5B594*/, 0x7DC400 /*0x9CCD00*/);
    }

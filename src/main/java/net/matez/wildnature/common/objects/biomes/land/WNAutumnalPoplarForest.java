...
public class WNAutumnalPoplarForest extends WNBiome { 
    public WNAutumnalPoplarForest() { 
        super(WNBiomes.AutumnalPoplarForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.3F, 0.8F, NORMAL_MUSIC, 0xA64A25 /*0xA67131*/, 0xC72600 /*0xD03F00*/);
    }

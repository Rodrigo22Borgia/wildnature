...
public class WNSnowyTatraFoothills extends WNBiome { 
    public WNSnowyTatraFoothills() { 
        super(WNBiomes.SnowyTatraFoothills, Biome.Precipitation.SNOW, Biome.BiomeCategory.EXTREME_HILLS, -0.6F, 0.8F, NORMAL_MUSIC, 0xB5DA62 /*0x9DD858*/, 0xFBFF00 /*0xFFEA00*/);
    }

...
public class WNSafari extends WNBiome { 
    public WNSafari() { 
        super(WNBiomes.Safari, Biome.Precipitation.RAIN, Biome.BiomeCategory.SAVANNA, 0.8F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public SurfaceRules.RuleSource getSurface() {
        return WNSurface.SAND_SAND_GRAVEL_CONFIG;
    }
}
...
public class WNPoplarForest extends WNBiome { 
    public WNPoplarForest() { 
        super(WNBiomes.PoplarForest, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.6F, 0.8F, NORMAL_MUSIC, 0x8AC700 /*0x7DB300*/, 0x7DC400 /*0x9CCD00*/);
    }

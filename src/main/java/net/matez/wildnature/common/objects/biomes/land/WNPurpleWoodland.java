...
public class WNPurpleWoodland extends WNBiome { 
    public WNPurpleWoodland() { 
        super(WNBiomes.PurpleWoodland, Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, 0.21F, 0.5F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }

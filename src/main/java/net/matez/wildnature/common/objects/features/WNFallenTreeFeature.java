...
public class WNFallenTreeFeature extends Feature<NoneFeatureConfiguration> {

    public WNFallenTreeFeature(Codec<NoneFeatureConfiguration> p_65360_, WNStructurePlacement placement) {
        super(p_65360_);

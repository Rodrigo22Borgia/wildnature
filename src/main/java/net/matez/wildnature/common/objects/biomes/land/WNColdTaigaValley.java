...
public class WNColdTaigaValley extends WNBiome { 
    public WNColdTaigaValley() { 
        super(WNBiomes.ColdTaigaValley, Biome.Precipitation.SNOW, Biome.BiomeCategory.TAIGA, -0.5F, 0.4F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.THIN_PINE, 7, 0.5F, 2);
        addTree(event, WNExtraTrees.TREE_LARCH, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.TREE_SPRUCE_M, 3, 0.5F, 2);

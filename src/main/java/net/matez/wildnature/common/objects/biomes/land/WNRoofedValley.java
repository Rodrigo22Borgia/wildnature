...
public class WNRoofedValley extends WNBiome { 
    public WNRoofedValley() { 
        super(WNBiomes.RoofedValley, Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.4F, 0.8F, NORMAL_MUSIC, 0x5DB259 /*0x7FBC70*/);
    }
    ...
    public void applyCustomFeatures(BiomeLoadingEvent event) {
        ...
        addTree(event, WNExtraTrees.GREENWOOD, 1, 0.5F, 2);
        addTree(event, WNExtraTrees.OAKLANDS_SHRUB, 3, 0.5F, 2);
        addTree(event, WNExtraTrees.OAKLANDS_SMALLSHRUB, 5, 0.5F, 2);
        addTree(event, WNExtraTrees.ROWAN, 1, 0.5F, 2);

        // -- FLOWERS
        addPlant(event, FlowerType.CLOVER, 2);
        addPlant(event, FlowerType.GERANIUM_RED, 6);
        addPlant(event, FlowerType.GRASS_WHEAT, 2);
        addPlant(event, FlowerType.HYACINTH_DARK_BLUE, 6);
        ...
        addPlant(event, FlowerType.VIBURNUM_PINK, 12);
        addPlant(event, FlowerType.VIBURNUM_WHITE, 12);
        addPlant(event, FlowerType.YEW_BUSH, 2);
}
